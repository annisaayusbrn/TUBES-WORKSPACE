 ...
 * @author lenovo
 */
public class user_adminMaster extends javax.swing.JFrame {

    /**
     * Creates new form user
     */
    public user_adminMaster() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(user_adminMaster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new user_adminMaster().setVisible(true);
            }
        });
    }
